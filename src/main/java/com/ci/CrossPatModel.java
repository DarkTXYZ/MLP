...
public class CrossPatModel {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        List<String> modelStructures = new ArrayList<>();
        modelStructures.add("2-1S");
        modelStructures.add("2-2S-1S");
        modelStructures.add("2-4S-2S-1S");
        modelStructures.add("2-16T-8S-16S-1S");
        modelStructures.add("2-5T-3S-4T-1S");
